...
'''
    ...
    with open('run_pyguard.py', 'w', encoding='utf-8') as f:
...
'''
    ...
    # Write using utf-8 to avoid encoding issues on Windows consoles
    with open('tools/check_requirements.py', 'w', encoding='utf-8') as f:
